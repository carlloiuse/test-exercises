...
SECRET_KEY = "=xquuw60t^xshc!q+bgv^9zb96qej%6g(ov_=ij^o0bwxpe3xn"
...
GEOIP_PATH = normpath(join(SITE_ROOT, 'geoip'))
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': join(SITE_ROOT, 'morse_code.log'),
        ...
        'warning': {
            ...
            'filters': ['warn_only'],
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': join(SITE_ROOT, 'warning.log'),
            'maxBytes': 1024*1024*5,
            'backupCount': 5,
            'formatter': 'verbose',
        },
